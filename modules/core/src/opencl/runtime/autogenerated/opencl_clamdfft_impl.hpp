...
//    OPENCLAMDFFT_FN_clfftSetPlanDim = 21,
    OPENCLAMDFFT_FN_clfftSetPlanDistance = 22,
    OPENCLAMDFFT_FN_clfftSetPlanInStride = 23,
//    OPENCLAMDFFT_FN_clfftSetPlanLength = 24,
    OPENCLAMDFFT_FN_clfftSetPlanOutStride = 25,
    OPENCLAMDFFT_FN_clfftSetPlanPrecision = 26,
    OPENCLAMDFFT_FN_clfftSetPlanScale = 27,
//    OPENCLAMDFFT_FN_clfftSetPlanTransposeResult = 28,
    OPENCLAMDFFT_FN_clfftSetResultLocation = 29,
    OPENCLAMDFFT_FN_clfftSetup = 30,
    OPENCLAMDFFT_FN_clfftTeardown = 31,
};
