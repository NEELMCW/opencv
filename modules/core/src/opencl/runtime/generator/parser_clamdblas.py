...
ctx = {}
ctx['CLBLAS_REMAP_ORIGIN'] = generateRemapOrigin(fns)
ctx['CLBLAS_REMAP_DYNAMIC'] = generateRemapDynamic(fns)
ctx['CLBLAS_FN_DECLARATIONS'] = generateFnDeclaration(fns)
...
ctx['CL_FN_ENUMS'] = generateEnums(fns, 'OPENCLBLAS_FN', )
ctx['CL_FN_SWITCH'] = generateTemplates(23, 'openclamdblas_fn', 'openclamdblas_check_fn', '')
ctx['CL_FN_ENTRY_DEFINITIONS'] = generateStructDefinitions(fns, 'openclamdblas_fn', 'OPENCLBLAS_FN')
