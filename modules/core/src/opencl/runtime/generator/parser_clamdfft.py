...
ctx = {}
ctx['CLFFT_REMAP_ORIGIN'] = generateRemapOrigin(fns)
ctx['CLFFT_REMAP_DYNAMIC'] = generateRemapDynamic(fns)
ctx['CLFFT_FN_DECLARATIONS'] = generateFnDeclaration(fns)
...
ctx['CL_FN_ENUMS'] = generateEnums(fns, 'OPENCLFFT_FN')
ctx['CL_FN_SWITCH'] = generateTemplates(23, 'openclamdfft_fn', 'openclamdfft_check_fn', '')
ctx['CL_FN_ENTRY_DEFINITIONS'] = generateStructDefinitions(fns, 'openclamdfft_fn', 'OPENCLFFT_FN')
