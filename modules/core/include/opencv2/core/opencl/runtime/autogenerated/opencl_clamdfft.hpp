...
//
#ifndef OPENCV_CORE_OCL_RUNTIME_CLFFT_HPP
#error "Invalid usage"
#endif
...
// generated by parser_clamdfft.py
#undef clfftBakePlan
#define clfftBakePlan clfftBakePlan
#undef clfftCopyPlan
//#define clfftCopyPlan clfftCopyPlan
#undef clfftCreateDefaultPlan
#define clfftCreateDefaultPlan clfftCreateDefaultPlan
#undef clfftDestroyPlan
#define clfftDestroyPlan clfftDestroyPlan
#undef clfftEnqueueTransform
#define clfftEnqueueTransform clfftEnqueueTransform
#undef clfftGetLayout
//#define clfftGetLayout clfftGetLayout
#undef clfftGetPlanBatchSize
//#define clfftGetPlanBatchSize clfftGetPlanBatchSize
#undef clfftGetPlanContext
//#define clfftGetPlanContext clfftGetPlanContext
#undef clfftGetPlanDim
//#define clfftGetPlanDim clfftGetPlanDim
#undef clfftGetPlanDistance
//#define clfftGetPlanDistance clfftGetPlanDistance
#undef clfftGetPlanInStride
//#define clfftGetPlanInStride clfftGetPlanInStride
#undef clfftGetPlanLength
//#define clfftGetPlanLength clfftGetPlanLength
#undef clfftGetPlanOutStride
//#define clfftGetPlanOutStride clfftGetPlanOutStride
#undef clfftGetPlanPrecision
//#define clfftGetPlanPrecision clfftGetPlanPrecision
#undef clfftGetPlanScale
//#define clfftGetPlanScale clfftGetPlanScale
#undef clfftGetPlanTransposeResult
//#define clfftGetPlanTransposeResult clfftGetPlanTransposeResult
#undef clfftGetResultLocation
//#define clfftGetResultLocation clfftGetResultLocation
#undef clfftGetTmpBufSize
#define clfftGetTmpBufSize clfftGetTmpBufSize
#undef clfftGetVersion
#define clfftGetVersion clfftGetVersion
#undef clfftSetLayout
#define clfftSetLayout clfftSetLayout
#undef clfftSetPlanBatchSize
#define clfftSetPlanBatchSize clfftSetPlanBatchSize
#undef clfftSetPlanDim
//#define clfftSetPlanDim clfftSetPlanDim
#undef clfftSetPlanDistance
#define clfftSetPlanDistance clfftSetPlanDistance
#undef clfftSetPlanInStride
#define clfftSetPlanInStride clfftSetPlanInStride
#undef clfftSetPlanLength
//#define clfftSetPlanLength clfftSetPlanLength
#undef clfftSetPlanOutStride
#define clfftSetPlanOutStride clfftSetPlanOutStride
#undef clfftSetPlanPrecision
#define clfftSetPlanPrecision clfftSetPlanPrecision
#undef clfftSetPlanScale
#define clfftSetPlanScale clfftSetPlanScale
#undef clfftSetPlanTransposeResult
//#define clfftSetPlanTransposeResult clfftSetPlanTransposeResult
#undef clfftSetResultLocation
#define clfftSetResultLocation clfftSetResultLocation
#undef clfftSetup
#define clfftSetup clfftSetup
#undef clfftTeardown
#define clfftTeardown clfftTeardown
