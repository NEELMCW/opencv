...
if(HIP_FOUND)
  ...
  foreach(ARCH IN LISTS ARCH_LIST)
    if(ARCH MATCHES "([0-9]+)\\(([0-9]+)\\)")
      ...
      IF (${HIP_PLATFORM} MATCHES "nvcc")
        set(NVCC_FLAGS_EXTRA ${NVCC_FLAGS_EXTRA} -gencode arch=compute_61,code=sm_61)
      ELSEIF(${HIP_PLATFORM} MATCHES "hcc")
        set(NVCC_FLAGS_EXTRA ${NVCC_FLAGS_EXTRA})
      ENDIF() #HIP_PLATFORM
  ...
  foreach(ARCH IN LISTS ARCH_LIST)
    set(NVCC_FLAGS_EXTRA ${NVCC_FLAGS_EXTRA} -gencode arch=compute_61,code=compute_61)
  ...
  macro(ocv_cuda_compile VAR)
    ...
    elseif (${HIP_PLATFORM} MATCHES "hcc")
        INCLUDE_DIRECTORIES("/opt/rocm/include/" "/opt/rocm/hip/include/" "/opt/rocm/hipblas/include" )
